...
module.exports = new ScriptTemp(['tab', 'incr'],
    ...
    local function ${this.name} (res, stepAlias, params)
        ...
        if(params.isTrue == true) then
            stepRes.trueRedisRes = redis.call(params.command, params.tab, unpack(params.args))
        else
            stepRes.falseRedisRes = redis.call(params.command, params.tab, unpack(params.args))
        end
    end
    `;
    },
